...
namespace InheritanceLecture
{
    class Program
    {
        ...
        public static void AuctionItOut()
        {
        ...
        public static void ZombieTime()
        {
            ZombiePlayer player = new ZombiePlayer();
            player.Name = "William";

            player.TakeRoll();
            Console.WriteLine($"Name: {player.Name}");
            Console.WriteLine($"Round: {player.RoundCount}");
            Console.WriteLine($"Total Brains: {player.TotalBrains}");
            Console.WriteLine($"Turn Brains: {player.TurnBrains}");
            Console.WriteLine($"Turn Blasts: {player.TurnBlasts}");
            Console.WriteLine($"Current Feet: {player.TurnFeet}");
        ...
        {
            Die die = cup.PullDie();
            Console.WriteLine($"You rolled a {die.Color} {die.Roll()} {die.RollSound()}");
        }
    }
}
