...
namespace Lecture.Tests
{
    ...
    public class ValidationTests
    {
        ...
        public void Test_16_ReturnBigEvenNumber()
        {
            ...
            Assert.AreEqual("Big Number", exercises.ReturnBigEvenNumber(100), "Number is 100. It is even, and a multiple of 5, but not larger than 100. It should be \"Big Number\".");
            Assert.AreEqual("Big Number", exercises.ReturnBigEvenNumber(102), "Number is 102. It is even, but not a multiple of 5. It should be \"Big Number\".");
